                                    ...
                                    <div class="card-header2">
                                      <span
                                        ...
                                        <!-- <div class="dateAuthor">
                                          {{ this.news_info.news_flash_date }}
                                      ...
                                      <el-button class="button2"
                                        >{{ this.news_info.news_flash_region }}
                                      </el-button>
                                      <el-button class="button2"
                                        >{{ this.news_info.news_flash_tag }}
                                      </el-button>
                                    </div>
                                  </template>
                                  <div class="content_main">
                                    {{ this.news_info.news_flash_content.substr(0,100)+"..." }}
                                  </div>
...
export default {
  ...
  created() {
    ...
    //   // var count=res.count;
    //   console.log(res.newsflashs);
    //   var response=res.newsflashs
    //   console.log(response);
    
    //   this.news_info=response;
    // }).catch(errMsg=>{
    //   console.log(errMsg);
    // })
